...
```{r}
methods2disp = c("Pirat", "Pirat_degenerated", "SeqKNN", "ImpSeq", "BPCA", "MinProb", "QRILC") # Choose imputation methods to display
...
p <- p + xlab("MNAR proportion") + ylab("Average MAE") + 
  ...
  theme(panel.background = element_blank(),
        legend.position = "none",# c(0.25, 0.76),
        legend.title.align=0.5,
        legend.title = element_text(size=11),
        legend.text = element_text(size=11),
        legend.key = element_rect(fill = "white"))
p
ggsave(file.path(path2res, paste0("mae_mnar_allmeth1", name.data, ".pdf")),
  width = 5, height = 5,
...
p <- p + xlab("MNAR proportion") + ylab("Average RMSE") + 
  ...
  theme(panel.background = element_blank(),
        ...
        legend.key = element_rect(fill = "white"))
p
ggsave(file.path(path2res, paste0("rmse_mnar_", name.data, ".pdf")),
  width = 5, height = 5,
  device = "pdf") # To save figure
```
